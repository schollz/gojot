...
func binAdjectivesTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "bin/adjectives.txt", size: 9106, mode: os.FileMode(438), modTime: time.Unix(1474930722, 0)}
...
func binNounsTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "bin/nouns.txt", size: 4036, mode: os.FileMode(438), modTime: time.Unix(1474930722, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
