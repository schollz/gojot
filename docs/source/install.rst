...
When you first run *sdees* you will be prompted for a ``git`` repository. If you have an account
...
That's it! If you'd like to see help, simply use ``--help`` or check out `usage guide`_ for more information about what *sdees* can do.
